...
public class ImageProcessing {
     ...
     *
     * @param filePath Path to the image. This parameter accepts a {@linkplain  String} that is the path to an image formats supported by
     *                 {@link ImageIO#read(URL)}.
     * @throws IOException Exceptions that might occur.
    ...
    public ImageProcessing(String filePath) throws IOException {
        ...
        Image im = img.getScaledInstance(side, side, Image.SCALE_DEFAULT);
    ...
    /**
     * @return The number of pixels associated with the {@link BufferedImage} of the object.
     */
    public int getSide() {
        return side;
    }
    ...
    /**
     * @return Processed {@link BufferedImage} linked with {@link ImageProcessing} object.
     */
